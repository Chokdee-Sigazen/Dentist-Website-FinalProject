...
export default async function PastApptCard(props: ApptInfoProps) {
    ...
    return (
        <div className="w-[100%] h-auto bg-[#61C0BF] text-[#FFFFFF] rounded-md drop-shadow-md my-2 px-4 py-3 ">
            <div className="text-[16pt] sm:text-[18pt] md:text-[20pt] font-bold">นัดที่ผ่านมา : {date}</div>

...
export default function ProfileTab(props: { name: string }) {
  return (
    <div className=" text-right">
      <Menu
        as="div"
        className="relative fle inline-block text-left bg-[#72A3A2] rounded-lg"
      >
        <div>
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    className={`${
                      active ? "bg-[#72A3A2] text-white" : "text-gray-900"
                    } group flex w-full items-center rounded-md px-2 py-2 text-sm`}
                  >
                    {active ? (
                      <DeleteActiveIcon
  ...
  return (
    ...
    >
      <rect
        ...
        strokeWidth="2"
      />
      <path d="M3 6H17" stroke="#72A3A2" strokeWidth="2" />
      <path d="M8 6V4H12V6" stroke="#72A3A2" strokeWidth="2" />
    </svg>
  );
}
